...
full`, 92 production HTTP route registrations / 78 unique URL paths, 89 CLI subcommands (87 in the default build) at v0.8.0 (post FX-12/ARCH-3 + FX-C3 batch2 + #1389 L2 `RecoverPreviousSession` + #1443 `Expand` + #1598 `Reembed` + #1727 `UndoEdit`), tens of

...
full`, 90 production HTTP route registrations / 76 unique URL paths, 82 CLI subcommands (80 in the default build) at v0.7.x (post FX-12/ARCH-3 + FX-C3 batch2 + #1389 L2 `RecoverPreviousSession` + #1443 `Expand` + #1598 `Reembed`), tens of

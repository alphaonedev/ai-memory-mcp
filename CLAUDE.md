...
full`, 87 production HTTP route registrations / 73 unique URL paths, 80 CLI subcommands at v0.7.0 (post FX-12/ARCH-3 + FX-C3 batch2 + #1389 L2 `RecoverPreviousSession`), tens of

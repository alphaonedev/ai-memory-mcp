...
mcp__memory__memory_store {
  ...
  kind: "decision",   // valid kinds = all 13 MemoryKind variants (docs/memory-kind-vocab.md): the 10-item Form-6 vocabulary PLUS Goal/Plan/Step (v0.8.0 Pillar-2 typed-cognition, #1709) — "plan" IS a valid kind

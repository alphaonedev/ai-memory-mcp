...
full`, 97 production HTTP route registrations / 83 unique URL paths, 94 CLI subcommands (92 in the default build) at v1.0.0 (post FX-12/ARCH-3 + FX-C3 batch2 + #1389 L2 `RecoverPreviousSession` + #1443 `Expand` + #1598 `Reembed` + #1727 `UndoEdit` + #1978 `Watch`), tens of

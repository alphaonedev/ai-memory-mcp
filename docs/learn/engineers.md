...
- **Federation:** peers exchange memories over mTLS with enrollment, per-write
  ...
  [certification](../compliance/ENTERPRISE-FEDERATION-CERTIFICATION.md).
...
ceiling — [certification §1 and §6](../compliance/ENTERPRISE-FEDERATION-CERTIFICATION.md).
...
[enterprise-federation-repro](../compliance/enterprise-federation-repro.html).
...
7. [enterprise deployment](../enterprise.html) → 8. [certification](../compliance/ENTERPRISE-FEDERATION-CERTIFICATION.md) → 9. [Batman mode](../batman-active-mode.html) + [repro kit](../compliance/enterprise-federation-repro.html) →

...
| c | Poor approval workflows | `track_g_hook_pipeline` (§2.7 — 27 events, `AskUser` decision class) + pending_actions K10 SSE (`/api/v1/approvals/stream` with mandatory HMAC) | structurally_addressed |

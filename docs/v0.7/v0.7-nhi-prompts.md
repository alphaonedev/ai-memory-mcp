...
> **Companion to** [`V0.7-EPIC.md`](V0.7-EPIC.html). One paste-ready prompt per task. Hand any of these verbatim to a Claude Code, Grok, Codex, or any MCP-capable agent and the agent has enough context to begin work without further briefing.
...
**Companion documents:**
- [`V0.7-EPIC.md`](V0.7-EPIC.html) — narrative, why-this-release-exists, sequencing, acceptance criteria
- This file — paste-ready execution prompts
- [`rfc-attested-cortex.md`](rfc-attested-cortex.html) — design RFC (to be written under F6)

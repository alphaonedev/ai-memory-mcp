...
**Supersedes:** [v0.6.5 epic (`cortex-fluent`)](../v0.6.5/V0.6.5-EPIC.html) — rolled into this document
**Predecessor:** [v0.6.4 — `quiet-tools`](../v0.6.4/V0.6.4-EPIC.html) — shipped 2026-05-05
**Original v0.7 spec:** [ROADMAP.md §7.3](../../ROADMAP.md) (Q2 2026, June target — now consolidating into `attested-cortex`)
...
**Narrative 2 — `attested` (trust) — from ROADMAP §7.3:**
...
*This track is unchanged from the v0.6.5 epic. Five tasks A1-A5. See [v0.6.5 epic Track A](../v0.6.5/V0.6.5-EPIC.html#track-a--substrate-response-shape) for full details + starter prompts. Summary:*
...
*This track is unchanged from the v0.6.5 epic. Five tasks B1-B5. See [v0.6.5 epic Track B](../v0.6.5/V0.6.5-EPIC.html#track-b--loader-tools) for full details + starter prompts. Summary:*
...
- Why Ed25519 over X25519 + ChaCha20 (separate concern; X25519 belongs to v0.8 end-to-end encryption per ROADMAP v0.8)
...
- [v0.6.5 epic (now superseded)](../v0.6.5/V0.6.5-EPIC.html) — cortex-fluent narrative, rolled into this epic
- [ROADMAP.md §7.3](../../ROADMAP.md) — original v0.7 spec (Q2 2026 target; now consolidating into `attested-cortex`)
...
- [`docs/v0.7/rfc-attested-cortex.md`](rfc-attested-cortex.html) — F6: design RFC (compat-matrix authoritative source)
- [`docs/v0.7/canonical-phrasings.md`](canonical-phrasings.html) — A1+A2: canonical phrasings for capabilities v3 / loaders
- [`docs/MIGRATION_v0.7.md`](../MIGRATION_v0.7.html) — F1: operator upgrade guide (v0.6.4 → v0.7.0)

...
- Env-knob house style: `ENV_VECTOR_NS_ALLOWLIST` at `src/hnsw.rs:107`, read through `crate::env_flag::neutral_enabled` (the #3200 shared grammar, 1/true/yes/on; a security knob is a registered `env_flag::knobs` entry instead), "Default: unset ⇒ legacy unfiltered search, byte-identical" (:100-106); consumed in handlers/recall.rs ~:746-760.

...
```
main.rs            -- Thin CLI shim (W6 refactor); top-level Command enum now lives in daemon_runtime.rs (99 subcommands with --features sal, 97 in the default build)

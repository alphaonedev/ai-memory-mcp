...
3. **HTTP daemon** -- an Axum web server exposing the same operations as a REST API with 98 route registrations / 84 unique URL paths (completely AI-agnostic)
...
Start the HTTP daemon (98 route registrations / 84 unique URL paths).

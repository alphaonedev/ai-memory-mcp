...
storage/           -- sqlite SQL primitives; CRUD, FTS5, recall scoring, GC, migration (CURRENT_SCHEMA_VERSION = 76)
...
Tracks migration state. Current version: **73** (`CURRENT_SCHEMA_VERSION` in `src/storage/migrations.rs`).

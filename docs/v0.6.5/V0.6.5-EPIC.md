...
> **⚠️ This epic was rolled into [v0.7.0 — `attested-cortex`](../v0.7/V0.7-EPIC.html) on 2026-05-05.** The Tracks A–F documented here are preserved as the cortex-fluent narrative inside the larger v0.7.0 release; they are now Tracks A, B, C, D, E, F of the [v0.7.0 epic](../v0.7/V0.7-EPIC.html). Open the v0.7.0 doc for the canonical, current scope. This file is retained for historical reference only.
...
- [v0.6.4 Epic](../v0.6.4/V0.6.4-EPIC.html) — predecessor

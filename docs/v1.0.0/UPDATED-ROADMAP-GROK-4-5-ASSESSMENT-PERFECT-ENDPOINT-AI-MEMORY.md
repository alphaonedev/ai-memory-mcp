...
flowchart TB
  subgraph PRE["PRE · honesty + field path"]
    ...
    E01[E0.1 Reflect family stamp E2E]
    E0 --> E01
  end
  ...
  subgraph INTEGRITY["INTEGRITY · procurement"]
    E5[E5 asi-hard profile + PE-1 + K2 require]
    E6[E6 append_only honesty + ns write≠Any]
    G2 --> E5
    G3 --> E5
    E5 --> E6
  end
  ...
  subgraph CUTLINE["SECONDARY H* — never block G0–G3"]
    H1[H1 OTel]
    H2[H2 mDNS or inventory-only ADR]
    H3[H3 MVCC or cut ADR]
    H4[H4 #1706→#1707 iff shadow]
    H5[H5 C-ABI]
    H6[H6 algorithm_id scaffold]
  end

...
// detection) instead of the fixed 10s constant this file used to carry
// (and that `tests/issue_1317_cli_reflect_wire_layer_preserves_caller_
// metadata.rs` copied verbatim before it flaked on PR #2522).

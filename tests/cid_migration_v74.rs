...
fn v74_columns_and_version_both_backends() {
    ...
    // Tip pin: the ladder head advanced to v80 (#1949 custody-class +
    // signed revocation; was v79 = crypto-core stage 2) — the v74 cid
    ...
    assert_eq!(
        ...
        80,
        "re-open stays at the v80 tip idempotently"
    );
    assert!(
        conn2

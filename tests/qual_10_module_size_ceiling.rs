...
const MODULE_SIZE_CEILINGS: &[(&str, usize)] = &[
    ...
    ("src/mcp/mod.rs", 16_400), /* 2026-08-04 #2544 (CB-15): the namespace-standard lifecycle/expiry

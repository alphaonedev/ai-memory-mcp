...
const MODULE_SIZE_CEILINGS: &[(&str, usize)] = &[
    ...
    ("src/storage/migrations.rs", 6_640), /* 2026-08-30 (#3172 schema-masks-data-loss gate): the `lineage_integrity_watermark` bootstrap SCHEMA table grows this file to MEASURED 6_541 (the enforce gate itself lives in db::open/connection.rs + schema_integrity.rs, not here). Ceiling 6_540 -> 6_640 (+99 headroom, lockstep, never lower). PRIOR: 2026-08-25 (#3221 rebase onto 5cb2dc31): MEASURED 6_463. Ceiling 6_400 -> 6_540 (+77 headroom). Never lower a floor. */

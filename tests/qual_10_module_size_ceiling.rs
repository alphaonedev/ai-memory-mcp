...
const MODULE_SIZE_CEILINGS: &[(&str, usize)] = &[
    ...
    ("src/storage/mod.rs", 30_220), /* 2026-08-25 (#3223 rebase onto ecce0a86): #3085 unattributed embedding_space fragments stacked on #3221's 30_220 floor (never lower). Incoming stale 29_340 discarded. Remeasure after gates. PRIOR: 2026-08-24 (#3221 rebase onto 5cb2dc31): #3161 gc/archive-then-delete link snapshot ON TOP OF #3220 dest-execute refuse. HEAD measured 29_936 at 30_020; incoming #3161 measured +~200 on its base. Ceiling 30_020 -> 30_220. */

...
const MODULE_SIZE_CEILINGS: &[(&str, usize)] = &[
    ...
    ("src/daemon_runtime.rs", 10_500), /* 2026-07-12 #1963 inference-egress gate at build_llm_client/build_embedder (9_999); 2026-07-15 #2095 route agents bind/revoke-api-key verbs through the SAL store (build_store_handle) so postgres enrollment works → 10_407 */

...
const MODULE_SIZE_CEILINGS: &[(&str, usize)] = &[
    ...
    ("src/storage/mod.rs", 30_220), /* 2026-08-25 (#3224 rebase onto 9f9e1605): #3013/#3012 archive-first delete + purge rails stacked on #3223's 30_220 floor (never lower). Incoming stale 29_340 discarded. Remeasure after gates. PRIOR: 2026-08-25 (#3223 rebase onto ecce0a86): #3085 unattributed embedding_space fragments stacked on #3221's 30_220 floor. PRIOR: 2026-08-24 (#3221): #3161 gc/archive-then-delete link snapshot. Ceiling 30_020 -> 30_220. */

...
const MODULE_SIZE_CEILINGS: &[(&str, usize)] = &[
    ...
    ("src/config.rs", 14_880), /* 2026-09-02 (#3467 EPIC #3466 wake-hub core): the `[wake_hub]` config block (`WakeHubConfig` + allowlist + parity test) lands config.rs at 14_773; ceiling 14_880 (+107 headroom). Prior: */

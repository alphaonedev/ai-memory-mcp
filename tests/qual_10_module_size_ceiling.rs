...
const MODULE_SIZE_CEILINGS: &[(&str, usize)] = &[
    ...
    /* 2026-09-13 (Conductor, second pass) — migrations.rs headroom set from the
     * QUEUE, not just the current actual. The first sweep used tip actual + 60,
     * which the reviewer correctly pointed out is still short once BOTH queued
     * branches land: #2462/#2463 adds 69 and #3655-v3 adds 25, taking 7_284 to
     * 7_378. Headroom that ignores known pending work is the same tripwire in
     * slower motion. Set to cover the queue plus a function: 7_440. */
    ("src/storage/migrations.rs", 7_440), /* 2026-09-03 (#3344 v96 embed_skip rung merged onto the #3419 v95 rung): the merge result lands migrations.rs at 7_007 — neither side alone breached 6_930; 7_300 leaves room for the #3464 v97 rung. Prior: */

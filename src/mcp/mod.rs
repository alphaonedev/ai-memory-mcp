    ...
    match req.method.as_str() {
        ...
        "tools/call" => {
            ...
            let result = match tool_name {
                ...
                // v0.7.0 Wave-2 fix B2 (S6-M1) — cross-peer reflection
                // provenance introspection. Reports
                // `metadata.peer_origin` (when present), the source
                // peer's recorded depth, and the local depth-at-arrival
                // snapshot so a curator can reconstruct attribution
...
mod tests {
    ...
    fn tool_definitions_returns_50_tools() {
        ...
        // v0.7.0 Wave-2 fix B2 (S6-M1) adds memory_reflection_origin
        // (Family::Power) → 53.
    ...
    fn tool_definitions_for_profile_full_registers_51() {
        ...
        assert_eq!(
            ...
            "full profile = v0.6.3 surface (43) + v0.7.0 I4 memory_replay (1) + \
             ...
             v0.7.0 Wave-2 fix B2 S6-M1 memory_reflection_origin (1) = 53"
        );
    }

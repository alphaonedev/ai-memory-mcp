...
impl McpTool for SessionStartTool {
    ...
    fn docs() -> &'static str {
        "Most-recently-accessed/updated. Near-duplicates are clustered (#3352) so the limit budget prefers distinct facts. At smart/autonomous tier, includes LLM summary."
    }

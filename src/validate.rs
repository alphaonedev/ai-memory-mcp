...
/// (`EXPECTED_PRODUCTION_ROUTES_COUNT=94` in `src/lib.rs`), MCP
/// tools (`Profile::full().expected_tool_count()=103` per
/// `src/profile.rs`), CLI subcommands
/// (`EXPECTED_CLI_SUBCOMMANDS_DEFAULT=90` / `_SAL=92` in `src/lib.rs`)

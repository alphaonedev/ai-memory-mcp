...
/// substrate-native recursive-learning mission, and v30 from L1-5's
/// `skills` + `skill_resources` tables backing the Agent Skills
/// ingestion substrate — Pillar 1.5). When a DB's

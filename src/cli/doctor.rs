...
mod tests {
    ...
    fn run_tokens_human_default_profile_is_core() {
        ...
        assert!(
            stdout.contains("Full   (57 tools loaded)"),
            "report should include full-profile baseline (43 + v0.7.0 I4 memory_replay + v0.7 H4 memory_verify + v0.7 B1 memory_load_family + v0.7 B2 memory_smart_load + v0.7 K7 memory_subscription_replay + memory_subscription_dlq_list + v0.7 J7 memory_find_paths + v0.7 K8 memory_quota_status + v0.7.0 Task 4/8 memory_reflect + v0.7.0 L1-5 5×skill tools = 57)"
        );
        assert!(
    ...
    fn run_tokens_raw_table_includes_per_tool_rows() {
        ...
        assert_eq!(
            tools.len(),
            57,
            "raw_table must include all 57 baseline tools (43 + v0.7.0 I4 memory_replay + v0.7 H4 memory_verify + v0.7 B1 memory_load_family + v0.7 B2 memory_smart_load + v0.7 K7 memory_subscription_replay + memory_subscription_dlq_list + v0.7 J7 memory_find_paths + v0.7 K8 memory_quota_status + v0.7.0 Task 4/8 memory_reflect + v0.7.0 L1-5 5×skill tools = 57)"
        );

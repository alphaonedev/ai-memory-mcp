...
mod tests {
    ...
    fn run_tokens_human_default_profile_is_core() {
        ...
        assert!(
            ...
            "report should include full-profile baseline (43 + v0.7.0 I4 memory_replay + v0.7 H4 memory_verify + v0.7 B1 memory_load_family + v0.7 B2 memory_smart_load + v0.7 K7 memory_subscription_replay + memory_subscription_dlq_list + v0.7 J7 memory_find_paths + v0.7 K8 memory_quota_status + v0.7.0 Task 4/8 memory_reflect + v0.7.0 Wave-2 fix B2 (S6-M1) memory_reflection_origin)"
        );
        assert!(
    ...
    fn run_tokens_json_emits_structured_payload() {
        ...
        // v0.7.0 Wave-2 fix B2 (S6-M1) — bumped to 11K to absorb the
        // memory_reflection_origin addition; see sizes.rs canonical
        // assertion for the same widening.
        assert!(

...
///
/// Certificate lifetime remains bounded independently of the refreshed public
/// revocation cache. A requested window above this maximum is refused.
...
pub fn check_ttl(delegation: &HubDelegation<'_>) -> Result<(), HubDelegationError> {
    ...
    if end - start > chrono::Duration::seconds(MAX_DELEGATION_TTL_SECS) {

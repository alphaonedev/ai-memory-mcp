...
mod tests {
    ...
    fn table_has_51_entries_matching_tool_definitions_count() {
        ...
        assert_eq!(
            n, 57,
            "expected exactly 57 tools (v0.6.3.1 baseline 43 + v0.7.0 I4 \
             ...
             + v0.7.0 Task 4/8 `memory_reflect` + v0.7.0 L1-5 \
    ...
    fn full_profile_total_in_honest_measured_range() {
        ...
        assert!(
            ...
            "full-profile total {total} tokens is outside the measured \
             cl100k_base range (5K–12K, source-of-truth incl. v0.7 C2 \
             `docs` fields + v0.7.0 L1-5 5 skill tools). If the schema \
             grew, update the public claim in RFC/README/roadmap and \
             adjust this bound."
        );
    }

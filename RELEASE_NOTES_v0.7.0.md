...
- **Schema v49 sqlite + v49 postgres in lockstep**
  (`CURRENT_SCHEMA_VERSION = 49`; canonical anchors:
  ...
  and the v49 archived_memories 14-column carry from #1025 so archive →
  restore is lossless for the full v0.7.0 26-field Memory shape).

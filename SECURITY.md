...
Last updated: 2026-09-11 (#3200 one boolean env grammar + the asi-hard daemon bind posture: 29 pinned knobs, non-loopback plaintext bind refused). Previous: 2026-09-11 (#3549 caller-authority boundary + the #3125 / F13 rulings). Previous: 2026-08-16 (v1.0.0 federation secure-default flips #2448/#2477/#1801→#1954/#1936/#1947/#2447 documented; federation-is-plaintext (#1968 OPEN) posture note added; `asi-hard` hardened profile (then 27 knobs) cross-referenced; honest tamper-evidence-not-proof / rollback-estimable-not-attestable boundary added; SQLCipher whole-DB at-rest build-flag caveat added. 2026-07-11: v1.0.0 supply-chain CycloneDX SBOM, #1973).

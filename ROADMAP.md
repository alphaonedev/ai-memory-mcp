...
| Refactor `db.rs` behind trait | 1–2 | Trait approved | `SqliteBackend` impl, all 33 public functions wrapped, 188 tests green |
...
| Integration test matrix | 1 | All backends | CI pipeline testing all backends against 188-test suite |
...
1. **188 existing tests green** — zero regression

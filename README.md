...
- **95 CLI subcommands under `--features sal` OR `--features sal-postgres`** (93 in the default build) -- complete CLI with identical capabilities, including `ai-memory features` (#2676)

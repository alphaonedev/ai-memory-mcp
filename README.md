...
[![Tests](https://img.shields.io/badge/tests-131_(88_unit_+_43_integration)-brightgreen)]()
...
### Quality
- **131 tests** -- 88 unit tests across 10 modules (db 29, mcp 12, config 9, validate 8, reranker 7, toon 6, models 6, embeddings 5, hnsw 4, llm 2) + 43 integration tests. 10/14 modules have unit tests.
